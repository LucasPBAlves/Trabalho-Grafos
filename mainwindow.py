...
from telas.screen19 import Screen19
...
class MainWindow(QMainWindow):
    ...
    def handle_action_from_screen4(self, screen_id):
        ...
        if screen_id == 5:
            ...
            self.prepare_screen15()

        elif screen_id == 16:
            self.prepare_screen16()
            
        elif screen_id == 17:
            self.prepare_screen17()
        
        elif screen_id == 18:
            self.prepare_screen18()

        elif screen_id == 19:
            self.prepare_screen19()
    ...
    def prepare_screen15(self):
        if not hasattr(self, 'screen15'):
            self.screen15 = Screen15()
            self.screen15.backSignal.connect(lambda: self.goto_screen(self.stackedWidget.indexOf(self.screen4)))
            self.stackedWidget.addWidget(self.screen15)
        self.stackedWidget.setCurrentWidget(self.screen15)
    ...
    def prepare_screen17(self):
                if not hasattr(self, 'screen17'):
                    self.screen17 = Screen17()
                    self.screen17.backSignal.connect(lambda: self.goto_screen(self.stackedWidget.indexOf(self.screen4)))
                    self.stackedWidget.addWidget(self.screen17)
                self.stackedWidget.setCurrentWidget(self.screen17)
    ...
    def prepare_screen19(self):
        if not hasattr(self, 'screen19'):
            self.screen19 = Screen19()
            self.screen19.backSignal.connect(lambda: self.goto_screen(self.stackedWidget.indexOf(self.screen4)))
            self.stackedWidget.addWidget(self.screen19)
        self.stackedWidget.setCurrentWidget(self.screen19)
